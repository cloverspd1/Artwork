namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork ABSQ Approver Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkABSQApproverSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkABSQApproverSection"/> class.
        /// </summary>
        public ExistingArtworkABSQApproverSection()
        {
        }
        ...
        public ExistingArtworkABSQApproverSection(bool isSet)
        {
            if (isSet)
            {
