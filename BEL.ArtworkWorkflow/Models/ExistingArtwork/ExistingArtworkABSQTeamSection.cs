namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork ABSQ Team Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkABSQTeamSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkABSQTeamSection"/> class.
        /// </summary>
        public ExistingArtworkABSQTeamSection()
        {
        }
        ...
        public ExistingArtworkABSQTeamSection(bool isSet)
        {
            if (isSet)
            {
