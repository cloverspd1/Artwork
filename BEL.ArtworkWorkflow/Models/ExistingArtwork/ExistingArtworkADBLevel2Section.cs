namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork ADB Level 2 Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkADBLevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkADBLevel2Section"/> class.
        /// </summary>
        public ExistingArtworkADBLevel2Section()
        {
        }
        ...
        public ExistingArtworkADBLevel2Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ArtworkListNames.EXISTINGARTWORKLIST, true) };
                this.SectionName = ArtworkSectionName.ADBLEVEL2SECTION;
