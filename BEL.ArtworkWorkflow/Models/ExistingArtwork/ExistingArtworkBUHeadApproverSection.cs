namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork BU Head Approver Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkBUHeadApproverSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkBUHeadApproverSection"/> class.
        /// </summary>
        public ExistingArtworkBUHeadApproverSection()
        {
        }
        ...
        public ExistingArtworkBUHeadApproverSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ArtworkListNames.EXISTINGARTWORKLIST, true) };
                this.SectionName = ArtworkSectionName.BUHEADAPPROVERSECTION;
