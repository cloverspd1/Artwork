namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    public class ExistingArtworkDetailSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkDetailSection"/> class.
        /// </summary>
        public ExistingArtworkDetailSection()
        {
        }
        ...
        public ExistingArtworkDetailSection(bool isSet)
        {
            if (isSet)
            {
        ...
        /// <summary>
        /// Gets or sets the requester domestic or imported.
        /// </summary>
        /// <value>
        /// The requester domestic or imported.
        /// </value>
        [DataMember]
        public string RequesterDomesticOrImported { get; set; }
