namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork Marketing Level 1 Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkMarketingLevel1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkMarketingLevel1Section"/> class.
        /// </summary>
        public ExistingArtworkMarketingLevel1Section()
        {
        }
        ...
        public ExistingArtworkMarketingLevel1Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ArtworkListNames.EXISTINGARTWORKLIST, true) };
                this.SectionName = ArtworkSectionName.MARKETINGLEVEL1SECTION;
