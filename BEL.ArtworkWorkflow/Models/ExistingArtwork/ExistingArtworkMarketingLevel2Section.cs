namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork Marketing Level 2 Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkMarketingLevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkMarketingLevel2Section"/> class.
        /// </summary>
        public ExistingArtworkMarketingLevel2Section()
        {
        }
        ...
        public ExistingArtworkMarketingLevel2Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ArtworkListNames.EXISTINGARTWORKLIST, true) };
                this.SectionName = ArtworkSectionName.MARKETINGLEVEL2SECTION;
