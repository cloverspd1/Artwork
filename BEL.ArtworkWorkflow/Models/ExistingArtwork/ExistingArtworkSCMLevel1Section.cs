namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork SCM Level1 Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkSCMLevel1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkSCMLevel1Section"/> class.
        /// </summary>
        public ExistingArtworkSCMLevel1Section()
        {
        }
        ...
        public ExistingArtworkSCMLevel1Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ArtworkListNames.EXISTINGARTWORKLIST, true) };
                this.SectionName = ArtworkSectionName.SCMLEVEL1SECTION;
