namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    /// <summary>
    /// Existing Artwork SCM Level2 Section
    /// </summary>
    [DataContract, Serializable]
    public class ExistingArtworkSCMLevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistingArtworkSCMLevel2Section"/> class.
        /// </summary>
        public ExistingArtworkSCMLevel2Section()
        {
        }
        ...
        public ExistingArtworkSCMLevel2Section(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(ArtworkListNames.EXISTINGARTWORKLIST, true) };
                this.SectionName = ArtworkSectionName.SCMLEVEL2SECTION;
