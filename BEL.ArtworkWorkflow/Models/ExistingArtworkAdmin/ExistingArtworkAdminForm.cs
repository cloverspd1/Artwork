namespace BEL.ArtworkWorkflow.Models.ExistingArtwork
{
    ...
    public class ExistingArtworkAdminForm : IForm
    {
        /// <summary>
        ...
        public ExistingArtworkAdminForm(bool setSections)
        {
            if (setSections)
            {
                this.ApprovalMatrixListName = ArtworkListNames.EXISTINGARTWORKAPPAPPROVALMATRIX;
                this.SectionsList = new List<ISection>();
                this.SectionsList.Add(new ExistingArtworkAdminDetailSection(true));
        ...
        {
            get { return ArtworkFormNames.EXISTINGARTWORKADMINFORM; }
        }
