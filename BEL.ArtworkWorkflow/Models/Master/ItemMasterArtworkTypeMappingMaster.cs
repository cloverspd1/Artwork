namespace BEL.ArtworkWorkflow.Models.Master
{
    ...
    public class ItemMasterArtworkTypeMappingMaster : IMaster
    {
        /// <summary>
        ...
        {
            get { return ArtworkMasters.ITEMMASTERARTWORKTYPEMAPPINGMASTER; }
            set { }
        }
        ...
        {
            get { return typeof(ItemMasterArtworkTypeMappingMasterListItem); }
            set { }
        }
    }
}