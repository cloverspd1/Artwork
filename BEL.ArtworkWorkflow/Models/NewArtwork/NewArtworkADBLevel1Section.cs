namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork ADB Level 1 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkADBLevel1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkADBLevel1Section"/> class.
        /// </summary>
        public NewArtworkADBLevel1Section()
        {
        }
        ...
        public NewArtworkADBLevel1Section(bool isSet)
        {
            if (isSet)
            {
