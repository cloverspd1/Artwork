namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork ADB Level 2 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkADBLevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkADBLevel2Section"/> class.
        /// </summary>
        public NewArtworkADBLevel2Section()
        {
        }
        ...
        public NewArtworkADBLevel2Section(bool isSet)
        {
            if (isSet)
            {
