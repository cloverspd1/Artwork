namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork BU Head Approver Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkBUHeadApproverSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkBUHeadApproverSection"/> class.
        /// </summary>
        public NewArtworkBUHeadApproverSection()
        {
        }
        ...
        public NewArtworkBUHeadApproverSection(bool isSet)
        {
            if (isSet)
            {
