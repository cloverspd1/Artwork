namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork Marketing Level 1 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkMarketingLevel1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkMarketingLevel1Section"/> class.
        /// </summary>
        public NewArtworkMarketingLevel1Section()
        {
        }
        ...
        public NewArtworkMarketingLevel1Section(bool isSet)
        {
            if (isSet)
            {
