namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork Marketing Level 2 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkMarketingLevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkMarketingLevel2Section"/> class.
        /// </summary>
        public NewArtworkMarketingLevel2Section()
        {
        }
        ...
        public NewArtworkMarketingLevel2Section(bool isSet)
        {
            if (isSet)
            {
