namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork QA Level 1 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkQALevel1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkQALevel1Section"/> class.
        /// </summary>
        public NewArtworkQALevel1Section()
        {
        }
        ...
        public NewArtworkQALevel1Section(bool isSet)
        {
            if (isSet)
            {
