namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork QA Level 2 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkQALevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkQALevel2Section"/> class.
        /// </summary>
        public NewArtworkQALevel2Section()
        {
        }
        ...
        public NewArtworkQALevel2Section(bool isSet)
        {
            if (isSet)
            {
