namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork SCM Level1 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkSCMLevel1Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkSCMLevel1Section"/> class.
        /// </summary>
        public NewArtworkSCMLevel1Section()
        {
        }
        ...
        public NewArtworkSCMLevel1Section(bool isSet)
        {
            if (isSet)
            {
