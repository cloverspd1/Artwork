namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    /// <summary>
    /// New Artwork SCM Level2 Section
    /// </summary>
    [DataContract, Serializable]
    public class NewArtworkSCMLevel2Section : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkSCMLevel2Section"/> class.
        /// </summary>
        public NewArtworkSCMLevel2Section()
        {
        }
        ...
        public NewArtworkSCMLevel2Section(bool isSet)
        {
            if (isSet)
            {
