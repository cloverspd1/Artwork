namespace BEL.ArtworkWorkflow.Models.NewArtwork
{
    ...
    public class NewArtworkAdminDetailSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewArtworkAdminDetailSection"/> class.
        /// </summary>
        public NewArtworkAdminDetailSection()
        {
        }
        ...
        public NewArtworkAdminDetailSection(bool isSet)
        {
            if (isSet)
            {
