...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        maxFiles: 10,
        // validation        
        allowedExtensions: ["avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "zip", "ppt", "pptx", "aif", "m3u", "mp3", "ra", "wav", "wma", "avi", "flv", "mov", "mp4", "mpg", "wmv", "bmp", "ico", "gif", "jpg", "jpeg", "png", "psd", "raw", "tif"], //[ "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "rtf", "html", "zip", "rar", "mp3", "wma", "mpg", "flv", "avi", "jpg", "jpeg", "png", "gif", "ppt", "pptx", "txt"],
        sizeLimit: 0,
        minSizeLimit: 0,
        duplicateCheck: true,
        // events
...
qq.FileUploaderBasic.prototype = {
    ...
    _isAllowedExtension: function (fileName) {
        ...
        var allowedExtension1 = ["avi", "pdf", "doc", "docx", "msg", "xls", "xlsx", "csv", "txt", "zip", "ppt", "pptx", "aif", "m3u", "mp3", "ra", "wav", "wma", "avi", "flv", "mov", "mp4", "mpg", "wmv", "bmp", "ico", "gif", "jpg", "jpeg", "png", "psd", "raw", "tif"];
    ...
    _onComplete: function (id, fileName, result) {
        ...
        if (typeof (result.IndividualUpload) !== "undefined" && result.IndividualUpload) {
            ...
            $(item).find(".qq-upload-status-text").html('<i data-url="' + result.FileURL + '" onclick="DownloadUploadedFile(this);" class="fa fa-download"></i>' +
                "<i data-id='" + result.FileId + "' onclick='" + "RemoveImage(this);' class='fa fa-trash-o'></i>");
        } else {
            qq.addClass(item, this._classes.fail);
            $(item).find(".qq-upload-status-text").text("Fail");
            setTimeout(function () {
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    */
    _upload: function (id, params) {
        ...
        params = params || {};
        params['qqfile'] = name;
        params['modelName'] = $("#ItemCode").val(); //$('.absqModelName').val(); //
        var queryString = qq.obj2url(params, this._options.action);
        ...
        $(uploadList).each(function (i, item) {
            var uploadItem = $('<li class="qq-upload-success"><span class="qq-upload-file">' + item.FileName + '</span>' +
               ...
               // '<i data-id="' + item.FileId + '" onclick="' + uploaderSelectorId + 'RemoveImage(this);" class="fa fa-trash-o"></i>' +
                '<i data-id="' + item.FileId + '" onclick="' + 'RemoveImage(this);" class="fa fa-trash-o"></i>' +
                '</span></li>');
